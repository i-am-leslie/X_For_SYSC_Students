...
if __name__ == "__main__":
    ...
    # Files to be tested
    file_names = ["LESLIE_EJEH_a02.sql", "register.php",
                  "profile.php", "index.php"]

    # Update according to where your website is located
    URL = "http://localhost/SYSC4504_Labs/Leslie_Ejeh_A02/"
        ...
        if ".sql" in file:
            ...
            try:
                ...
                for item in index_fields.items():
                    ...
                    submit = driver.find_element(By.ID, "post")  # Use By.ID to find the button with the ID "post"
                    submit.click()      
